...
!    !$ include 'omp_lib.h'
    ...
    INTEGER  :: ispecies, imolecule, this_box, this_locate, jspecies, jmolecule, this_locate3
    
    REAL(DP) :: Eij_vdw, Eij_qq, Eijk_triad
    REAL(DP) :: eps
    REAL(DP) :: rcom, rx, ry, rz

    LOGICAL :: get_interaction

    INTEGER :: locate_1, locate_2, locate_3
...
END SUBROUTINE Compute_Molecule_Self_Energy
  ...
  SUBROUTINE Compute_System_Total_Energy(this_box,intra_flag,overlap)
    ...
    INTEGER :: im, is, this_im, im_1, im_2, im_3, is_1, is_2, is_3, this_im_1, this_im_2, this_im_3 

    REAL(DP) :: v_mol_bond, v_mol_angle, v_mol_dihedral, v_mol_improper
    REAL(DP) :: v_mol_intra_vdw, v_mol_intra_qq, v_mol_inter_qq
    REAL(DP) :: vlj_pair, vqq_pair, e_lrc, vlj_triad
    REAL(DP) :: rcom, rx, ry, rz
    REAL(DP) :: E_inter_vdw, E_inter_qq
    REAL(DP) :: v_mol_self
    REAL(DP) :: rijsq
    ...
    INTEGER :: locate_1, locate_2, locate_3
    LOGICAL :: l_pair_store, my_overlap, shared_overlap, l_triad_store
       ...
       imLOOP1: DO im_1 = 1, nmols(is,this_box)
          ...
          imLOOP2: DO im_2 = im_1 + 1, nmols(is,this_box)
            ...
            ! rijsq = rcom * rcom 
			 ...
			 imLOOP5: DO im_3 = im_2 + 1, nmols(is,this_box)
				 this_im_3 = locate(im_3,is,this_box)
				 IF (.NOT. molecule_list(this_im_3,is)%live) CYCLE imLOOP5
				 ...
				 CALL Check_MoleculePair_Cutoff(this_im_3,is,this_im_2,is,get_interaction, &
					  rcom,rx,ry,rz)
