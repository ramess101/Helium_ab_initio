...
#        f1.write(str(Tsat_i)+'\t'+str(np.round(rhol_avg[iTsat]/Mw_He,3))+'\t'+str(np.round(rhol_95[iTsat]/Mw_He,3))+'\t'+str(np.round(rhov_avg[iTsat]/Mw_He,3))+'\t'+str(np.round(rhov_95[iTsat]/Mw_He,3))+'\t'+str(np.round(Psat_avg[iTsat]/10.,4))+'\t'+str(np.round(Psat_95[iTsat]/10.,4))+'\n')
    ...
    ax0[0].errorbar(rhol_avg[Tsat_avg >= Tplot_low]/Mw_He,Tsat_avg[Tsat_avg >= Tplot_low],xerr=rhol_95[Tsat_avg >= Tplot_low]/Mw_He,fmt=color+shape,mfc='None',markersize=10,markeredgewidth=2,label=system_label+', GEMC',capsize=6)
    ax0[0].errorbar(rhov_avg[Tsat_avg >= Tplot_low]/Mw_He,Tsat_avg[Tsat_avg >= Tplot_low],xerr=rhov_95[Tsat_avg >= Tplot_low]/Mw_He,fmt=color+shape,mfc='None',markersize=10,markeredgewidth=2,capsize=6)
    ax0[0].errorbar(rhor_avg[Tsat_avg >= Tplot_low]/Mw_He,Tsat_avg[Tsat_avg >= Tplot_low],xerr=rhor_95[Tsat_avg >= Tplot_low]/Mw_He,fmt=color+shape,mfc='None',markersize=10,markeredgewidth=2,capsize=6)
    ...
    ax0[0].errorbar(rhoc/Mw_He,Tc,xerr=urhoc/Mw_He,yerr=uTc,fmt=color+shape,markersize=10,markeredgewidth=2,mfc=color,label=system_label+', Critical, GEMC',capsize=6)
   
### Old, mass basis     
#    ax0[0].errorbar(rhol_avg[Tsat_avg >= Tplot_low],Tsat_avg[Tsat_avg >= Tplot_low],xerr=rhol_95[Tsat_avg >= Tplot_low],fmt=color+shape,mfc='None',markersize=10,markeredgewidth=2,label=system_label+', GEMC',capsize=6)
#    ax0[0].errorbar(rhov_avg[Tsat_avg >= Tplot_low],Tsat_avg[Tsat_avg >= Tplot_low],xerr=rhov_95[Tsat_avg >= Tplot_low],fmt=color+shape,mfc='None',markersize=10,markeredgewidth=2,capsize=6)
#    ax0[0].errorbar(rhor_avg[Tsat_avg >= Tplot_low],Tsat_avg[Tsat_avg >= Tplot_low],xerr=rhor_95[Tsat_avg >= Tplot_low],fmt=color+shape,mfc='None',markersize=10,markeredgewidth=2,capsize=6)
...
#    ax0[0].errorbar(rhoc,Tc,xerr=urhoc,yerr=uTc,fmt=color+shape,markersize=10,markeredgewidth=2,mfc=color,label=system_label+', Critical, GEMC',capsize=6)
    
    ax0[1].errorbar(invTsat_avg[invTsat_avg <= invTplot_low],logPsat_avg[invTsat_avg <= invTplot_low]-1,yerr=logPsat_95[invTsat_avg <= invTplot_low],fmt=color+shape,mfc='None',markersize=10,markeredgewidth=2,capsize=6)#,label=system_label+', GEMC')
#    ax0[1].plot(invTsat,logPsat-1,color+shape,mfc='None',label=system_label+', GEMC')
    ax0[1].plot(invTplot[invTplot <= invTplot_low],logPsatplot[invTplot <= invTplot_low]-1,color+line)#,label=system_label+', Fit, GEMC')
#    ax0[1].errorbar(10./Tc,np.log10(Pc)-1,xerr=uinvTc,yerr=ulogPc,fmt=color+'d',markersize=14,mfc='None')#,label=system_label+', Critical, GEMC')
    ax0[1].errorbar(10./Tc,np.log10(Pc)-1,xerr=uinvTc,yerr=ulogPc,fmt=color+shape,markersize=10,markeredgewidth=2,mfc=color,capsize=6)#,label=system_label+', Critical, GEMC')
...
#    ax1.plot(Tsat,Zv,color+shape,mfc='None',markersize=10)
    ax1.errorbar(Tsat_avg,Zv_avg,yerr=Zv_95,fmt=color+shape,mfc='None',markersize=10,markeredgewidth=2,capsize=6)
    ax1.errorbar(Tc,Zc,xerr=uTc,yerr=uZc,fmt=color+shape,markersize=10,markeredgewidth=2,mfc=color,capsize=6)
...
ax0[0].errorbar(rhoc_Kofke/Mw_He,Tc_Kofke,xerr=urhoc_Kofke/Mw_He,yerr=uTc_Kofke,color='cyan',marker='d',mfc='cyan',markersize=10,markeredgewidth=2,label='Critical, VEOS',capsize=6)
...
ax0[1].errorbar(10./Tc_Kofke,np.log10(Pc_Kofke)-1,xerr=uinvTc_Kofke,yerr=ulogPc_Kofke,color='cyan',marker='d',mfc='cyan',markersize=10,markeredgewidth=2,capsize=6)#,label='2-body, Critical, VEOS')
ax0[1].plot([],[],color='cyan',marker='d',linestyle='',mfc='cyan',markersize=10,markeredgewidth=2,label=r'(2+3)-body, Critical, VEOS$\infty$')
#ax0[1].set_xlabel(r'10/$T$ (1/K)',fontsize=28)
#ax0[1].set_ylabel(r'$\log_{10}$($P$/MPa)',fontsize=28)
...
ax1.errorbar(Tc_Kofke,Zc_Kofke,xerr=uTc_Kofke,yerr=uZc_Kofke,color='cyan',marker='d',markersize=10,markeredgewidth=2,mfc='cyan',capsize=6)
ax1.plot([],[],color='cyan',marker='d',linestyle='',markersize=10,markeredgewidth=2,mfc='cyan',label=r'(2+3)-body, Critical, VEOS$\infty$')
