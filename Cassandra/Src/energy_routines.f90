...
!    !$ include 'omp_lib.h'
  ...
  !----------------------------------------------------------------------------
    ...
    ! Returned
    REAL(DP) :: E_intra_vdw,E_intra_qq  ! TODO: All should be zero except for E_inter_vdw I suppose.
  ...
  !----------------------------------------------------------------------------
    ...
    ExistCheck: &
    IF (atom_list(ia,im,is)%exist .AND. atom_list(ja,jm,js)%exist) THEN  ! TODO: Cut everything below this
       rij = SQRT(rijsq)
       E_inter_vdw = V(rij)
...
!                W_tensor_charge(:,:,this_box) = W_tensor_charge(:,:,this_box) + tc_pair(:,:)
  ...
  !-----------------------------------------------------------------------------
    ...
    ! Returned
    REAL(DP) :: Wij_vdw,Wij_qq  ! TODO: Wij_qq should be zero I presume. 
